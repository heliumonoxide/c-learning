...
void nodeCheck( TreeNodePtr treePtr );
...
void nodeCheck(TreeNodePtr treePtr){
	...
	if(treePtr->leftPtr != NULL){
		printf("--left %d,", treePtr->leftPtr->data);
	}
	...
	if(treePtr->rightPtr != NULL){
		printf(" --right %d", treePtr->rightPtr->data);
	}
	...
	nodeCheck(treePtr->leftPtr);
	nodeCheck(treePtr->rightPtr);
}
